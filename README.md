...
- Movie Data sourced from [IMDB](https://developer.imdb.com/?ref=ft_ds), [Kaggle](https://www.kaggle.com/) <p "font-size:10px"><i>(note: due to size of the raw data files, they are not included within this repo) </i></p>
